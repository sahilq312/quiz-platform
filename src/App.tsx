  ...
  return (
    <div className="w-full min-h-screen">
        {/* <div className="flex flex-col items-center justify-center">
          ...
          {Quizzes?.title}
          <Link to={"/create"}>
          <button className="w-full" onClick={createQuiz}>Create Quiz</button></Link>
        </div> */}
        <div className="relative min-h-full isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          <svg
